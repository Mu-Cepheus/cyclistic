...
library(scales) #for scale modifications in graphs
getwd() #displays your working directory
setwd("~/Documents/Acad/Google Data/Case/data") #sets your working directory to simplify calls to data ... make sure to use your OWN username instead of mine ;)
...
#====================================================
# merge dataframes into single historical year
...
all_trips_v2 <- distinct(all_trips_v2) #remove duplicate rows if any
...
write.csv(counts, file = '~/Documents/Acad/Google Data/Case/data/avg_ride_length.csv')
